...
class VendorDetails(models.Model):
    ...
    rate = models.IntegerField(default=0, verbose_name="Fixed Charge", blank=True, null=True)
    additionalCharges = models.IntegerField(default=0, verbose_name="Misc Charge", blank=True, null=True)
...
class ConsigneeConsigner(models.Model):
    ...
    pincode = models.CharField(
        max_length=7, verbose_name="Pincode", null=True, blank=True)
    phone = models.CharField(default=None, max_length=10,
                             verbose_name="Phone", null=True, blank=True)
    tat = models.IntegerField(
        default=None, verbose_name="Tat", null=True, blank=True)

    rate = models.IntegerField(
        default=0, verbose_name="Rate", null=True, blank=True)
    odaCharge = models.IntegerField(
        default=0, verbose_name="ODA Charges", null=True, blank=True)
    ...
    user_id = models.ForeignKey(Users, on_delete=models.CASCADE,
                                related_name="user_id", default=1, verbose_name="Users")
    vendor_id = models.ForeignKey(VendorDetails, on_delete=models.SET_NULL, null=True,
...
class Consignment(models.Model):
    ...
    consigner_id = models.ForeignKey(
        ConsigneeConsigner, on_delete=models.CASCADE, related_name="consigner_id", verbose_name="Reciever")
    ...
    user_id = models.ForeignKey(Users, on_delete=models.CASCADE,
                                related_name="consignment_user_id", verbose_name="User", default=1)
    status = models.CharField(max_length=100, choices=ConsignemntStatusChoices,
                              default="created", verbose_name="Consignment Status")
    pod = models.FileField(upload_to='pod/', blank=True,
                           null=True, verbose_name="Proof of Delivery")
    mode = models.CharField(max_length=100, choices=ConsignmentModeChoices,
                            default="forward", verbose_name="Consignment Mode")
    reverseDocketNo = models.CharField(
        default=0, max_length=100, verbose_name="Reverse Docket Number", blank=True, null=True)
    remarks = models.CharField(
        max_length=500, verbose_name="Remarks", blank=True, null=True)
    ...
    additionalCharges = models.DecimalField(
...
class Billings(models.Model):
    ...
    consigneeName = models.CharField(
        max_length=300, null=True, blank=True, default=None)
    consignerName = models.CharField(
        max_length=300, null=True, blank=True, default=None)
    ...
    additionalCharge = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True, default=0)
    odaCharge = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True, default=0)
    ...
    cp_additionalCharge = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True, default=0)
    cp_odaCharge = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True, default=0)
    cp_totalAmount = models.DecimalField(
        max_digits=10, decimal_places=2, default=0)

    vehicleCharge = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True, default=0)
    miscCharge = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True, default=0)
    miscRemark = models.TextField(default=None, null=True, blank=True)
    labourCharge = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True, default=0)
